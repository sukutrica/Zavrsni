...
INSERT INTO ULAZ VALUES (2,1,1,11,45,1,65000);
INSERT INTO ULAZ VALUES (2,1,1,12,45,1,65000);
INSERT INTO ULAZ VALUES (2,1,1,13,90,4,120000);

INSERT INTO ULAZ VALUES (2,1,2,21,45,1,65000);
INSERT INTO ULAZ VALUES (2,1,2,22,45,1,65000);
INSERT INTO ULAZ VALUES (2,1,2,23,90,4,120000);

INSERT INTO ULAZ VALUES (2,1,3,31,45,1,65000);
INSERT INTO ULAZ VALUES (2,1,3,32,45,1,65000);
INSERT INTO ULAZ VALUES (2,1,3,33,90,4,120000);
...
INSERT INTO STANARI VALUES ('Zorana Radic',1,2,23,'123456787912347',2,3);
...
INSERT INTO STANARI VALUES ('Nikola Stosic',1,2,11,'223456787912341',2,2);
INSERT INTO STANARI VALUES ('Maja Pavic',1,2,12,'223456787912342',1,0);
INSERT INTO STANARI VALUES ('Jovana Zekic',1,2,13,'223456787912343',2,3);
INSERT INTO STANARI VALUES ('Srdjan Stojkov Simic',1,2,14,'223456787912344',2,4);

INSERT INTO STANARI VALUES ('Milica Drakul',1,2,21,'223456787912345',2,3);
...
INSERT INTO STANARI VALUES ('Nebojsa Djukanovic',1,2,31,'223456787912348',2,0);
INSERT INTO STANARI VALUES ('Dragan Bjelogrlic',1,2,32,'223456787912349',2,1);
INSERT INTO STANARI VALUES ('Aleksandar Vucic',1,2,33,'223456787912310',2,3);

INSERT INTO STANARI VALUES ('John Smith',1,2,41,'223456787912348',2,2);
INSERT INTO STANARI VALUES ('Senad Basic',1,2,42,'223456787912349',2,0);
INSERT INTO STANARI VALUES ('Marko Savkovic',1,2,44,'223456787912310',2,3);





INSERT INTO STANARI VALUES ('Zivojin Misic',2,1,11,'323456787912341',2,2);
INSERT INTO STANARI VALUES ('Eva RAs',2,1,12,'323456787912342',1,0);
INSERT INTO STANARI VALUES ('Tomislav nikolic',2,1,13,'323456787912343',2,3);


INSERT INTO STANARI VALUES ('Bruce Lee',2,1,21,'323456787912345',2,3);
INSERT INTO STANARI VALUES ('Samantha Fox',2,1,22,'323456787912346',1,1);
INSERT INTO STANARI VALUES ('Haris Dzinovic',2,1,23,'323456787912347',2,3);
...
SELECT Z.ADRESA, U.BRULAZA, U.SPRAT,U.BRSTANA,U.POVRSINA, S.IDVLASNIK,S.JMBG 
FROM ZGRADA Z, ULAZ U, STANARI S
WHERE Z.IDZGRADE=1 AND U.BRULAZA=1 AND U.SPRAT=2 AND U.BRULAZA=S.BRULAZA


SELECT S.IDVLASNIK, S.JMBG, U.SPRAT,S.BRSTANA, U.CENA, U.POVRSINA,S.BRODRASLI, S.BRDECA, U.BRULAZA, Z.ADRESA,Z.IDZGRADE, Z.OPSTINA
FROM ZGRADA Z, ULAZ U, STANARI S
WHERE Z.IDZGRADE=U.IDZGRADE AND U.BRULAZA=S.BRULAZA AND S.BRULAZA=U.BRULAZA AND S.BRSTANA=U.BRSTANA AND S.IDZGRADE=Z.IDZGRADE

SELECT U.IDZGRADE, U.BRSTANA
FROM ULAZ U, STANARI S, ZGRADA Z
WHERE U.BRSTANA NOT IN (SELECT S.BRSTANA FROM STANARI) 
  AND U.IDZGRADE = 1
  AND U.BRULAZA = S.BRULAZA
  AND Z.IDZGRADE = U.IDZGRADE
  AND Z.IDZGRADE = S.IDZGRADE
  ;
